...
Instead of bootstrap sample $\mathbf{X}^{(b)}$, *jackknife sample* $\mathbf{X}_{(i)}$ will be used. It leaves out the $i$-th observation.
...
For each $\mathbf{X}_{(i)}$, *jackknife replicate* which is a form of our interest is computed.
