...
Before performing bootstrap, we should define a `statistic` function. This function must take at least 2 arguments, data and index.
...
Consider medical patche data from @Efron:1994aa. It contains measurement for hormone into the blood stream of 8 subjects after wearing a medical patch. There are three different patches.
